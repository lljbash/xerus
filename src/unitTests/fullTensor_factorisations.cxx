...
static misc::UnitTest tensor_svd_rnd512("Tensor", "SVD_Random_512x512", [](){
	...
	MTEST(frob_norm(res1(i^3, m)*res1(i^3, n) - Tensor::identity(res2.dimensions)(m, n)) < 1e-12, " U not orthogonal " << frob_norm(res1(i^3, m)*res1(i^3, n) - Tensor::identity(res2.dimensions)(m, n)));
