...
namespace xerus {
	...
	*/
	namespace blasWrapper {
		...
		XERUS_deprecated("without lapacke the called QC factorization is not destructive anymore. call qc(...) instead of this function to call it directly. this function will be removed in xerus v5")zz
